...
fn schemas_match_expected_columns_and_canonical_types() {
    let expected = [
        ...
        ("reason", 3, 0x26d8d05cee4cb2c9),
        ("income_band", 3, 0xe4492be155956c52),
        ...
        ("catalog_returns", 27, 0x17864e12cc60535b),
        ("web_returns", 24, 0xaab028fb7cdefecb),
